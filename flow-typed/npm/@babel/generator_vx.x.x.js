// flow-typed signature: 970274e09e42730c13123458d0a341b5
// flow-typed version: <<STUB>>/@babel/generator_v7.16.8/flow_v0.170.0
...
declare module '@babel/generator' {
  ...
  declare export interface GeneratorOptions {
    ...
    jsescOption?: {
       ...
       */
      numbers?: 'binary' | 'decimal' | 'hexadecimal' | 'octal' | void,
       ...
       */
      quotes?: 'backtick' | 'double' | 'single' | void,
  ...
  declare export class CodeGenerator {
    constructor(ast: Node, opts?: GeneratorOptions, code?: string): this,
