...
export type { AutoEncryptionTlsOptions
/**
...
export type { ChangeStreamDocumentOperationDescription
/**
 * @public
...
export type { ChangeStreamDropDatabaseDocument
/**
 * @public
...
export type { ChangeStreamNameSpace
/**
...
export type { ChangeStreamReplaceDocument
/**
 * @public
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
...
declare interface FilterOperators<TValue> extends NonObjectIdLikeDocument {
  ...
  $mod?: $If<$Assignable<TValue, number>, [number, number], empty>,
  $regex?: $If<$Assignable<TValue, string>, RegExp | BSONRegExp | string, empty>,
  $options?: $If<$Assignable<TValue, string>, string, empty>,
  $geoIntersects?: {
    $geometry: Document,
    ...
  },
  ...
  $elemMatch?: Document,
  $size?: $If<$Assignable<TValue, ReadonlyArray<any>>, number, empty>,
...
declare type InferIdType<TSchema> = $If<$Assignable<TSchema, {
  _id: any,
  ...
}>, $If<$Assignable<Record<any, empty>, IdType>, empty, IdType>, $If<$Assignable<TSchema, {
  _id?: any,
  ...
...
export type { MongoCredentialsOptions
/**
...
declare type OptionalUnlessRequiredId<TSchema> = $If<$Assignable<TSchema, {
  _id: any,
  ...
...
declare interface TypedEventEmitter<Events: EventsDescription> extends EventEmitter {
  addListener<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  on<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  once<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  removeListener<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  off<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  removeAllListeners<EventKey: $Keys<Events>>(event?: EventKey | CommonEvents | symbol | string): this,
  listeners<EventKey: $Keys<Events>>(event: EventKey | CommonEvents | symbol | string): Events[EventKey][],
  rawListeners<EventKey: $Keys<Events>>(event: EventKey | CommonEvents | symbol | string): Events[EventKey][],
  emit<EventKey: $Keys<Events>>(event: EventKey | symbol, ...args: Parameters<Events[EventKey]>): boolean,
  listenerCount<EventKey: $Keys<Events>>(type: EventKey | CommonEvents | symbol | string): number,
  prependListener<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
  ...
  prependOnceListener<EventKey: $Keys<Events>>(event: EventKey, listener: Events[EventKey]): this,
